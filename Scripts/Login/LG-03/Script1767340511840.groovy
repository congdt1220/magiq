...
int MAX_RELOAD_ATTEMPTS = 2
int WAIT_ELEMENT_BEFORE_RELOAD = 120
int AFTER_LOGIN_WAIT = 120
// ----- Locator ổn định -----
...
while (attempts <= MAX_RELOAD_ATTEMPTS) {
	...
	WebUI.comment("Không thấy #userName sau ${WAIT_ELEMENT_BEFORE_RELOAD}s. Reload lần ${attempts + 1}.")
	WebUI.refresh()
