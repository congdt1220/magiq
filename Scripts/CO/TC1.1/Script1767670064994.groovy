...
aAccount.addProperty('xpath', ConditionType.EQUALS, "//a[@href='organisation']")
...
WebUI.click(findTestObject('CO/btt_change_org'))

WebUI.waitForElementVisible(findTestObject('CO/modal_org'), 30)
